	...
	public boolean substituteMethodInvocation(MethodInvocationElement invocation) {
		...
		if (targetClassName != null && targetExpression != null) {
			...
			case "java.util.TreeSet":
					...
					default:
						if (invocation.getArgumentCount() == 2) {
							print(invocation.getTargetExpression(), delegate).print(".splice(")
									.print(invocation.getArgument(0)).print(", 0, ").print(invocation.getArgument(1))
									.print(")");
						} else {
				...
				case "pop":
					printMacroName(targetMethodName);
					print(invocation.getTargetExpression(), delegate).print(".pop(")
							.printArgList(invocation.getArguments()).print(")");
					return true;
				case "peek":
				case "lastElement":
				...
				case "addFirst":
					printMacroName(targetMethodName);
					print(invocation.getTargetExpression(), delegate).print(".unshift(")
				...
				case "subList":
					printMacroName(targetMethodName);
					print(invocation.getTargetExpression(), delegate).print(".slice(")
							.printArgList(invocation.getArguments()).print(")");
					return true;
				case "size":
					printMacroName(targetMethodName);
				...
				case "contains":
					printMacroName(targetMethodName);
					print("(");
					print(invocation.getTargetExpression(), delegate).print(".indexOf(")
			...
			case "java.util.LinkedHashMap":
				if (((DeclaredType) targetExpression.getType()).getTypeArguments().size() == 2
					...
					case "size":
						printMacroName(targetMethodName);
						print("((m) => { if(m.entries==null) m.entries=[]; return m.entries.length; })(")
								.print("<any>");
						print(invocation.getTargetExpression(), delegate).print(")");
						return true;
					case "remove":
			...
			case "java.lang.StringBuilder":
				...
				case "charAt":
					printMacroName(targetMethodName);
					print(invocation.getTargetExpression(), delegate).print(".str.charAt(")
							.print(invocation.getArgument(0)).print(")");
					return true;
				case "setLength":
					printMacroName(targetMethodName);
			...
			case "java.util.GregorianCalendar":
				...
				case "setTimeInMillis":
					printMacroName(targetMethodName);
					print(invocation.getTargetExpression(), delegate).print(".setTime(")
							.print(invocation.getArgument(0)).print(")");
					return true;
				...
				case "setTime":
					printMacroName(targetMethodName);
					print(invocation.getTargetExpression(), delegate).print(".setTime(")
							.print(invocation.getArgument(0)).print(".getTime())");
					return true;
				case "getTime":
					printMacroName(targetMethodName);
					print("(new Date(");
