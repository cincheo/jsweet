...
public class NativeStructuresTests extends AbstractTest {
	...
	public void testCollections() {
		eval((logHandler, result) -> {
			...
			assertEquals(
					"1,a,1,b,3,4,d,a,d,0,0,0,a,a,2,a,true,false,3,c,c,a,b,c,a,b,c,b,1,c,b,a,b,c,a,0,true,true,it,true,1,[a,b,c],0,false,true,[a,b,c],[c,b,a],[aa,bb,cc],cc,[aa,bb]",
					result.get("trace"));
	...
	public void testMaps() {
		eval((logHandler, result) -> {
			Assert.assertEquals("There should be no errors", 0, logHandler.reportedProblems.size());
			assertEquals("1,a,2,b,2,a,true,[1,2],[a,b],1,true,1,2,[]", result.get("trace"));
