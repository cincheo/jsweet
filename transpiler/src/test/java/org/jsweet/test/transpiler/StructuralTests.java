...
public class StructuralTests extends AbstractTest {
    ...
    public void testDefaultMethodsHierarchy() {
        eval(ModuleKind.commonjs, (logHandler, r) -> {
            logHandler.assertNoProblems();
        }, getSourceFile(II1.class), getSourceFile(CC1.class), getSourceFile(CC2.class), getSourceFile(I1.class),
                getSourceFile(I2.class), getSourceFile(I3.class), getSourceFile(I4.class), getSourceFile(I5.class),
                getSourceFile(AbstractViewController.class), getSourceFile(IntermediateAbstractViewController.class),
                getSourceFile(FinalViewController.class));
    }
}
