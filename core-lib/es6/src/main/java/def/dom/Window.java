...
import jsweet.util.StringTypes.blur;
import jsweet.util.StringTypes.canplay;
import jsweet.util.StringTypes.canplaythrough;
import jsweet.util.StringTypes.change;
import jsweet.util.StringTypes.click;
import jsweet.util.StringTypes.compassneedscalibration;
import jsweet.util.StringTypes.contextmenu;
import jsweet.util.StringTypes.dblclick;
import jsweet.util.StringTypes.devicemotion;
import jsweet.util.StringTypes.deviceorientation;
import jsweet.util.StringTypes.drag;
import jsweet.util.StringTypes.dragend;
import jsweet.util.StringTypes.dragenter;
import jsweet.util.StringTypes.dragleave;
import jsweet.util.StringTypes.dragover;
import jsweet.util.StringTypes.dragstart;
import jsweet.util.StringTypes.drop;
import jsweet.util.StringTypes.durationchange;
import jsweet.util.StringTypes.emptied;
import jsweet.util.StringTypes.ended;
import jsweet.util.StringTypes.focus;
import jsweet.util.StringTypes.hashchange;
import jsweet.util.StringTypes.input;
import jsweet.util.StringTypes.keydown;
import jsweet.util.StringTypes.keypress;
import jsweet.util.StringTypes.keyup;
import jsweet.util.StringTypes.load;
import jsweet.util.StringTypes.loadeddata;
import jsweet.util.StringTypes.loadedmetadata;
import jsweet.util.StringTypes.loadstart;
import jsweet.util.StringTypes.message;
import jsweet.util.StringTypes.mousedown;
import jsweet.util.StringTypes.mouseenter;
import jsweet.util.StringTypes.mouseleave;
...
import jsweet.util.StringTypes.mousewheel;
...
import jsweet.util.StringTypes.pause;
import jsweet.util.StringTypes.play;
import jsweet.util.StringTypes.playing;
...
import jsweet.util.StringTypes.ratechange;
import jsweet.util.StringTypes.readystatechange;
import jsweet.util.StringTypes.reset;
import jsweet.util.StringTypes.resize;
import jsweet.util.StringTypes.scroll;
import jsweet.util.StringTypes.seeked;
import jsweet.util.StringTypes.seeking;
import jsweet.util.StringTypes.select;
import jsweet.util.StringTypes.stalled;
import jsweet.util.StringTypes.storage;
import jsweet.util.StringTypes.submit;
import jsweet.util.StringTypes.suspend;
import jsweet.util.StringTypes.timeupdate;
import jsweet.util.StringTypes.unload;
import jsweet.util.StringTypes.volumechange;
import jsweet.util.StringTypes.waiting;
