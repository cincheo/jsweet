...
public class HTMLVideoElement extends HTMLMediaElement {
    ...
    native public void addEventListener(jsweet.util.StringTypes.MSVideoFormatChanged type, java.util.function.Function<Event,java.lang.Object> listener, java.lang.Boolean useCapture);
    native public void addEventListener(jsweet.util.StringTypes.MSVideoFrameStepCompleted type, java.util.function.Function<Event,java.lang.Object> listener, java.lang.Boolean useCapture);
    native public void addEventListener(jsweet.util.StringTypes.MSVideoOptimalLayoutChanged type, java.util.function.Function<Event,java.lang.Object> listener, java.lang.Boolean useCapture);
    ...
    native public void addEventListener(jsweet.util.StringTypes.MSVideoFormatChanged type, java.util.function.Function<Event,java.lang.Object> listener);
    native public void addEventListener(jsweet.util.StringTypes.MSVideoFrameStepCompleted type, java.util.function.Function<Event,java.lang.Object> listener);
    native public void addEventListener(jsweet.util.StringTypes.MSVideoOptimalLayoutChanged type, java.util.function.Function<Event,java.lang.Object> listener);
