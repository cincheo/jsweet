...
public class Array<T> extends Iterable<T> {
    /**
    ...
    /**
      ...
      */
    native public <U extends T> T[] concat(@SuppressWarnings("unchecked") ItemsUs<U>... items);
    /**
      * Combines two or more arrays.
      * @param items Additional items to add to the end of array1.
      */
    native public T[] concat(@SuppressWarnings("unchecked") ItemsTs<T>... items);
    /**
    ...
    /** 
      ...
      */
    native public T find(jsweet.util.function.TriFunction<T,Double,Array<T>,java.lang.Boolean> predicate, java.lang.Object thisArg);
    /** 
      ...
      * predicate. If it is not provided, undefined is used instead.
      */
    native public double findIndex(java.util.function.Function<T,java.lang.Boolean> predicate, java.lang.Object thisArg);
    /**
      ...
      * length+end.
      */
    native public T[] fill(T value, double start, double end);
    /** 
      ...
      */
    native public T[] copyWithin(double target, double start, double end);
    /**
      * Adds all the elements of an array separated by the specified separator string.
      * @param separator A string used to separate one element of an array from the next in the resulting String. If omitted, the array elements are separated with a comma.
      */
    ...
    /** 
      ...
      * predicate. If it is not provided, undefined is used instead.
      */
    native public T find(jsweet.util.function.TriFunction<T,Double,Array<T>,java.lang.Boolean> predicate);
    /** 
      * Returns the index of the first element in the array where predicate is true, and undefined 
      * otherwise.
      * @param predicate find calls predicate once for each element of the array, in ascending 
      ...
      * predicate. If it is not provided, undefined is used instead.
      */
    native public double findIndex(java.util.function.Function<T,java.lang.Boolean> predicate);
    /**
      * Returns the this object after filling the section identified by start and end with value
      * @param value value to fill array section with
      * @param start index to start filling the array at. If start is negative, it is treated as 
      ...
      * length+end.
      */
    native public T[] fill(T value, double start);
    /**
      * Returns the this object after filling the section identified by start and end with value
      * @param value value to fill array section with
      * @param start index to start filling the array at. If start is negative, it is treated as 
    ...
    /** 
      ...
      * @param end If not specified, length of the this object is used as its default value. 
      */
    native public T[] copyWithin(double target, double start);
